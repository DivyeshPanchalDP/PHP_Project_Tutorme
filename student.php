...
$username = $_SESSION['username10'];
$usertype = $_SESSION['userType10'];

$_SESSION['user_id12']=$user_id;
$_SESSION['sername12']=$username;
$_SESSION['userType12']=$usertype;

if (isset($_SESSION['username10'])){
  ...
  if(mysqli_num_rows($select) > 0){ ?>
      ...
      <h1><u>PROFILE</u></h1>
        ...
        <form action="" method="">
          ...
          <a  style="float: right;" href="supdate.php" class="btn btn-primary" name="submit"> UPDATE PROFILE</a>
        </form>
      </div>
