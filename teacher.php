...
session_start();
$user_id = $_SESSION['user_id101'];
$username = $_SESSION['username101'];
$usertype = $_SESSION['userType101'];


$_SESSION['user_id11']=$user_id;
$_SESSION['sername11']=$username;
$_SESSION['userType11']=$usertype;

if (isset($_SESSION['username101'])){
...
<nav class="navbar navbar-expand-lg bg-dark navbar-scroll">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarContent">
            ...
            <li class="nav-item">
                <a class="nav-link" href="student_info.php">Managment</a>
              </li>
              <li class="nav-item">
  ...
  if(mysqli_num_rows($select) > 0){ ?>
      ...
      <div class="box">
        ...
        <form action="" method="">
          ...
          <a  style="float: right;" href="tupdate.php" class="btn btn-primary" name="submit1"> UPDATE PROFILE</a>
        </form>
      </div>
