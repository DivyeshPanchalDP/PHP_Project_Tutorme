...
session_start();
$user_id = $_SESSION['user_id12'];
$username = $_SESSION['username12'];
$usertype = $_SESSION['userType12'];
            ...
            <div class="card-body">
                <form action="" method="POST">
                  ...
                  <option value="Other"></option>
                    ...
                    <div class="form-group">
                        <button type="submit" name="update" style="margin: 9px 0;" class="btn btn-primary btn-block form-control">Update</button>
                    </div>
