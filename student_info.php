    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <body class="skin-black">
        ...
        <header class="header">
            ...
            <nav class="navbar navbar-static-top" style="background-color: grey ;" role="navigation">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                                        ...
                                        <li>
                                            <a href="teacher.php"><i class="fa fa-ban fa-fw pull-right"></i> Go to Profile</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
  ...
  $previous = $page_counter - 1;
                                        ...
                                        //echo $products[0]['student_id'];
                                         foreach ($products as $product) {
                                             $str.="<tr><td>".$product['student_first_name']."</td><td>".$product['student_last_name']."</td><td>".$product['student_contact']."</td>
