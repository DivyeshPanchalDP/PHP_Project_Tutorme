...
if (isset($_POST['submit'])) {
    ...
    $mobile = $_POST['phone'];
    $message = $_POST['mesg'];
			$sql = "INSERT INTO contact (name, email, mobile, message) VALUES ('$username', '$email', '$mobile', '$message')";
...
.card {
  ...
  <body>
    ...
    <div style="padding: 33px 5px; opacity: 0.8">
      <div
        class="row"
        style="padding: 50px 5px; opacity: 0.9"
      >
